...
public class loginPage {
	  public WebDriver driver;
 	    ...
 	    //implementing Encapsulation Concept here Declaring variables in private mode for  Data security issues
		...
		//Created constructor so when ever an object of this class is created this method is called so that the actual driver refers to the driver in this class
